...
export interface Casino {
  ...
  // New fields from MDX migration
  rating: number | null;                  // 1-5 star rating
  min_deposit: number | null;             // Minimum deposit in CAD
...
/**
 * Casino with parsed pros/cons arrays
 */
export interface CasinoParsed extends Omit<Casino, 'pros' | 'cons'> {
  pros: string[];
  cons: string[];
}
